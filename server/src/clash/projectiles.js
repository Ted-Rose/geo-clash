// Pure functions for the deterministic projectile telemetry model.
// The server commits a (origin, target, vMps, tSpawn, tArrival) packet exactly
// once per shot; clients extrapolate the position locally.
